...
- **功能开关**：可通过配置 `ENABLE_WEBSOCKET` 控制功能启停。
...
```env
# 数据库连接
DATABASE_URL=mysql+pymysql://root:root@localhost:3306/rbac_system
